...
const STRANDS = [
  ...
  },
  {
    ...
    practice: [
      ...
      "The walls reflect the learners and model excellence - or the space is the professional environment (a theatre, studio or workshop, for example)",
  ...
  },
  {
    ...
    levels: {
      ...
      Transformational: "Students set direction and manage the journey - making decisions, recovering from mistakes, and carrying learning into new contexts. Every student can name their own next step.",
    },
  },
];
...
// v6: adds the Trustee Learning Walk. The key bump makes browsers holding
// an old seed reseed (demo data resets).
const STORAGE_KEY = "brit-tl-studio-submissions-v6";
...
const POLICY_CHECKS = [
  ...
  { key: "chromebookOnly", label: "No smart devices being used or seen without pedagogical intent" },
];
const DEVICE_SCALE = [
...
const FORM_ACCENT = { "peer-review": "#AD227E", "walk-belonging": "#AD227E", "walk-room": "#8447B0", "walk-intent": "#C2651A", "walk-travel": "#46B749", "device-walk": "#C2651A", "trustee-walk": "#2A1E27", "dept-review": "#46B749", "aen-review": "#C0392B" };
    ...
    <div>
      ...
      <Card style={{ padding: 28, marginBottom: 22 }}>
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(180px,1fr))", gap: 18 }}>
          ...
          <Field label="Class (optional)">
            <input style={inputStyle} value={v.className} placeholder="e.g. 12A" onChange={(e) => set("className", e.target.value)} />
          </Field>
        </div>
      </Card>
      ...
      <Card style={{ padding: 28, marginBottom: 22 }}>
        <div style={{ display: "grid", gap: 20 }}>
          ...
          <Field label="What could you hear?">
            <textarea style={{ ...inputStyle, minHeight: 70, resize: "vertical" }} value={hear}
              placeholder="Conversations, questions, the buzz of learning - what did it sound like?"
              onChange={(e) => setHear(e.target.value)} />
          </Field>
          <Field label="How did it feel?">
            <textarea style={{ ...inputStyle, minHeight: 70, resize: "vertical" }} value={feel}
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 18, marginTop: 8, flexWrap: "wrap" }}>
        <button disabled={!complete} onClick={submit} style={{
          ...
          background: complete ? BRAND.magenta : BRAND.line, color: complete ? "#fff" : BRAND.grey,
          fontWeight: 700, fontSize: 14, cursor: complete ? "pointer" : "not-allowed", fontFamily: "inherit",
        }}>Submit walk</button>
    ...
    <div>
      ...
      {isDept && (
        <div style={{ marginBottom: 26 }}>
          <FeedbackReminder who="the staff you reviewed" />
        </div>
      )}
    ...
    <div>
      ...
      {(followUps.length > 0 || followUpsDone.length > 0) && (
        <Card style={{ padding: 28, marginBottom: 30, border: `2px solid ${followUps.length ? "#C0392B" : BRAND.line}`, background: followUps.length ? "#FCF2F2" : "#fff" }}>
          ...
          <p style={{ fontSize: 13, color: BRAND.grey, margin: "0 0 14px", lineHeight: 1.5 }}>
            These walks were flagged for follow-up - the reviewer should feed back to the staff reviewed within a week. Flip the switch once you've fed back.
          </p>
 ...
 * ------------------------------------------------------------------ */
const POLICY_SHORT = { phoneBox: "Phone box", headphones: "Headphones", chromebookOnly: "Devices on-task" };
