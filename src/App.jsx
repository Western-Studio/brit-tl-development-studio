  ...
  return (
    <div>
      ...
      <Card style={{ padding: "30px 32px 32px", marginBottom: 30 }}>
        ...
        {/* the honest bit */}
        <div style={{ marginTop: 24, borderTop: `1.5px solid ${BRAND.line}`, paddingTop: 16, fontSize: 12.5, color: BRAND.grey, lineHeight: 1.6 }}>
          <strong style={{ color: BRAND.ink }}>Straight talk about the data.</strong>{" "}
          BRIT is quality assurance as well as development, and we won't pretend otherwise: governors and
          SLT need a picture of teaching, and this is where it comes from. Your reviews and descriptors are
          visible to SLT and your line manager, and they aggregate by area, department, team and year group.
          Two things in return: the SLT page is open, so what leadership sees, you can see - and the
          descriptors are stages of development, read for patterns, not used to rank people.
        </div>
      </Card>
      ...
      {isDevice && (
        <>
          <Card style={{ padding: 28, marginBottom: 26 }}>
            ...
            <p style={{ fontSize: 13, color: BRAND.grey, margin: "0 0 16px", lineHeight: 1.5 }}>
              Three expectations, one honest reading of each. This is a policy check and SLT sees the
              results - it reads how the roll-out is landing, not the teacher's capability.
            </p>
        ...
        <Card style={{ padding: 28, marginBottom: 22, background: "#FDFBF6", borderColor: "#EFE3C8" }}>
          ...
          <p style={{ fontSize: 13, color: BRAND.grey, margin: "0 0 14px", lineHeight: 1.5 }}>
            {isDept
              ...
              : "The descriptors above feed the whole-school picture. This closing section is for the two of you - send your colleague away with something real to feel good about."}
          </p>
    ...
    <div>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", flexWrap: "wrap", gap: 12, marginBottom: 26 }}>
        <div>
          ...
          <p style={{ color: BRAND.grey, margin: 0, fontSize: 14 }}>
            The quality-assurance picture - the same data governors ask for, and this page is open to all staff.
          </p>
        </div>
      ...
      <Card style={{ padding: 28, marginBottom: 30 }}>
        ...
        <p style={{ fontSize: 13, color: BRAND.grey, margin: "0 0 16px", lineHeight: 1.5 }}>
          ...
          with a short reflection on how it went. Ideas that get tried are the point of the whole process -
          so this is a number we openly track.
        </p>
        {ideas.length === 0 ? (
...
Reviews use three DEVELOPMENTAL DESCRIPTORS: Developing (practice is taking root), Embedded (consistent everyday practice), Transformational (practice that lifts the whole room). They describe where practice currently sits on an area, as stages of a journey rather than pass/fail marks - and be straight with staff: the descriptors are counted. They feed the school's quality-assurance picture, aggregated by area, department, team and year group.
...
The follow-through loop: every peer review ends with one idea worth trying, and that idea stays open until its owner closes it. When a colleague with an open idea selects their name on the share board, the idea is pulled through automatically - they post a short update on how it went, evaluate it (Becoming habit / Tried it - refining / Adapted it) and tick it off. The next reviewer of that colleague sees last time's idea at the top of the form and asks how it went - trying the idea matters more than ticking the box. Ticked-off ideas and their reflections feed the SLT dashboard's follow-through view, which is a number the school openly tracks. Developmental success in this framework means movement: area profiles shifting from Developing toward Embedded and Transformational over time, every teacher engaged in the cycle, and ideas from reviews actually getting tried - the All Staff page has a "What developmental success looks like" panel explaining exactly this.

Be straight about what the system is, whenever staff ask. BRIT is BOTH quality assurance AND professional development, and it does not pretend otherwise: governors and SLT need data about teaching, and the Studio provides it - descriptor distributions, follow-through counts, and individual reviews visible to SLT and line managers. In return, the deal is transparency and purpose: the SLT analytics page is open to all staff (what leadership sees, staff can see), descriptors are read for patterns rather than used to rank individuals, and the parts of a review built for the conversation - the shout-out, even better if, and the idea worth trying - exist to develop practice, not to measure it. If someone asks "is this monitoring?", the honest answer is: the aggregated data quality-assures teaching, the conversations develop it, and both are real. Never claim there are no scores, no data, or no visibility - there are descriptors, they are counted, and staff deserve the truth about where their data goes.
